                ...
                <div className="w-full h-full flex relative justify-center items-center">
                    <section className="bg-white overflow-hidden rounded-lg shadow-2xl md:grid md:grid-cols-3">
                        ...
                        <div className="flex flex-col gap-3 justify-center items-center">
                            ...
                            <a href="https://www.instagram.com/skylerdevco/" className="flex gap-3">
                                <p className="font-teko text-2xl">Follow us on</p>
                            ...
                            <a href="https://www.linkedin.com/in/ayan-ali-developer/" className="flex gap-3">
                                <p className="font-teko text-2xl">Follow us on</p>
